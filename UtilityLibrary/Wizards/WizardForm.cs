...
{
  [ToolboxItem(true)]
  [ToolboxBitmap(typeof(UtilityLibrary.Wizards.WizardForm), "UtilityLibrary.Wizards.WizardForm.bmp")]
  ...
  public class WizardForm : System.Windows.Forms.UserControl
  {
    ...
    private UtilityLibrary.Wizards.LineFrame lineDownLimit;
    ...
    [Editor( "UtilityLibrary.Designers.FlagsEditor, UtilityLibrary.Designers, Version=1.0.4.0, Culture=neutral, PublicKeyToken=fe06e967d3cf723d", 
       typeof( UITypeEditor ) )]
    ...
    private void InitializeComponent()
    {
      ...
      this.lineDownLimit = new UtilityLibrary.Wizards.LineFrame();
